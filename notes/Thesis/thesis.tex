...
\begin{document}
	...
	\section{Attestor}
	% TODO include current model checking approach (only checking main state space)
	...
	\begin{definition}[Semantics of LTL over Paths and States \cite{baier2008principles}]\label{def:ltl_paths_semantics}
