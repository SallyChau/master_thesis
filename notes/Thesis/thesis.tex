	...
	\begin{figure}
		\begin{center}
			\resizebox{\textwidth}{!}{
				...
				\node (1) at (0.25,0) [normal] {};
				\node (2) at (1.25,0) [normal] {};
				\node (3) at (2.25,0) [normal,fill=gray] {};
				\node (head) at (-0.85,0) [var] {\texttt{head}};
				\draw[->,shorten >=0.5pt] (1) edge[bend left] node[above] {\texttt{n}} (2);
				\draw[->,shorten >=0.5pt] (2) edge[bend left] node[above] {\texttt{n}} (3);
				\draw (head) to (1);
				
				\node (AP) at (0.5,1.85) {$\{\texttt{identicNeighbors}\}$};
				...
				\node (AP) at (6,1.85) {$\{\texttt{identicNeighbors}\}$};
				
				%state 3
				\node (back3) at (11.5,0) [rectstyle] {};
				\node (text) at (9.5,1.25) {$s_2$};
				\node (1) at (11.15,0) [normal] {};
				\node (2) at (12.15,0) [normal] {};
				\node (3) at (13.15,0) [normal,fill=gray] {};
				\node (head) at (10.15,0) [var] {\texttt{head}};
				\node (current) at (12.15,1) [var] {\texttt{current}};
				\draw[->,shorten >=0.5pt] (1) edge[bend left] node[above] {\texttt{n}} (2);
				\draw[->,shorten >=0.5pt] (2) edge[bend left] node[above] {\texttt{n}} (3);
				\draw (head) to (1);
				\draw (current) to (2);
				
				\node (AP) at (11.5,1.85) {$\{\texttt{identicNeighbors}\}$};				
